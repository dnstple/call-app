...
export function demoData(role: Role): SignupData {
  ...
  if (role === 'member') {
    return {
      ...
      mediums: ['Phone call'], durationMins: 30,
  ...
  if (role === 'companion') {
    return {
      ...
      bio: 'I work in a library and spend weekends watching cricket or walking the Peaks. I love hearing how places used to be — the shops, the music, the matches. Happy to chat about almost anything, and I make a decent cup of tea (though you can’t taste it down the phone).',
      interests: ['Sport', 'Books', 'History', 'Travel'],
      languages: ['English'], fluency: 'Native',
      mediums: ['Phone call', 'WhatsApp', 'Zoom'],
